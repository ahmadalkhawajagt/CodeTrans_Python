...
def rbcvipi(me,vime, PAR, DSS, SSK, SSS, TM):
    ...
    maximization and vime = 1 referring to sophisticated continuous optimization
    (fminbnd alike).
    """
    #--------------------------------------------------------------------------
    ...
    if me == 0:
        ...
        while tol > 1e-4 and nitr <= 1500:
            ...
            print("Elapsed time for the for loops for iteration",'\033[1m' \
                  + str(nitr) + '\033[0m',\
